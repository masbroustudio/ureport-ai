...
> **Catatan**: struktur di bawah berasal dari **blueprint v2** (`docs/v2/`).
> Blueprint awal di `docs/ARCHITECTURE.md` mengusulkan struktur Next.js monolith + `services/python/` microservice.
>
> Tunggu konfirmasi user sebelum scaffolding.

## Layout Monorepo (target — versi v2)
